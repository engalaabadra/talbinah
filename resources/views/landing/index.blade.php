...
@section('meta')
	<title>@lang('custom.Talbinah App')</title>
	<meta name="title" content="Talbinah App">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="description" content="Get the mental health you need with the Talbinah app. Psychotherapy sessions
	...
	<meta property="og:title" content="Talbinah App">
	<meta property="og:description" content="Get the mental health you need with the Talbinah app. Psychotherapy sessions
	With the best psychiatry specialist in Saudi Arabia, available to you in the comfort of your home via the Internet. Start your psychological treatment today">
	...
	<meta property="twitter:title" content="Talbinah App">
	<meta property="twitter:description" content="Get the mental health you need with the Talbinah app. Psychotherapy sessions
	With the best psychiatry specialist in Saudi Arabia, available to you in the comfort of your home via the Internet. Start your psychological treatment today">
	<meta property="twitter:image" content="https://metatags.io/images/meta-tags.png">
	<!-- Meta Tags Generated with https://metatags.io -->
	<meta name="keywords" content="dr.abelmajeed,dr.mohammed,social workers,psychologists,psychotherapy">
    <meta name="Author" content="Talbinah">
    <meta name="copyright" content="© 2023 Talbinah All rights reserved ">
@endsection
							...
							<div class="dc-bringcarecontent">
								<div class="dc-sectionhead dc-sectionheadvtwo">
									...
									<div class="dc-description">
										<p>
											@lang('custom.Navigate your mental wellness with Talbinah, your personalized consultation app.')
										</p>
									</div>
								</div>
								<div class="dc-btnarea">
						...
						<div class="row justify-content-center align-self-center">
							<div class="col-xs-12 col-sm-12 col-md-8 push-md-2 col-lg-8 push-lg-2">
								<div class="dc-sectionhead dc-text-center">
									...
									<div class="dc-description">
										<p>
											@lang('custom.Talbinah, your go-to mental health support app! Connecting experts with those in need in a secure, family-friendly environment. Lets nurture our mental health together!')
										</p>
									</div>
								</div>
							</div>
											...
											<div class="item" >
												<div class="dc-docpostholder">
													<figure class="dc-docpostimg">
														@if($doctor->image)
															<img src="{{url('/'.$doctor->image->url)}}" alt="@lang('custom.img description')" style="height: 200px">
														@else
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 justify-content-center align-self-center">
							<div class="dc-appcontent">
								...
								<ul class="dc-appicons">
									...
									<li><a href="https://play.google.com/store/apps/details?id=com.talbinah.talbinah" target="_blank"><img src="{{url('/assets/images/app-imgs/img-03.png')}}" alt="@lang('custom.img description')"></a></li>
									<li><a href="https://apps.apple.com/app/talbinah-app/id6464413895" target="_blank"><img src="{{url('/assets/images/app-imgs/img-02.png')}}" alt="@lang('custom.img description')"></a></li>
								</ul>
							</div>
						</div>
					</div>
