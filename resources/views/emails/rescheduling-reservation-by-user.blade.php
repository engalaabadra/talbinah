...
@section('main-container')
    ...
    <p>نأمل أن تكون بأتم الصحة والعافية. نود أن نعلمك بأنه تم إعادة جدولة موعد الاستشارة الطبية المقررة معك في 
    <span class="otp">
        {{$emailData['old_reservation_start_time']}} : {{$emailData['old_reservation_end_time']}} في تاريخ : {{$emailData['old_reservation_date']}}
    </span></p>
    <ul>التفاصيل الجديدة لموعد الاستشارة هي كما يلي:</ul>
