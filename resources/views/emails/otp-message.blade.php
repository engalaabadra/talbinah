...
<div class="container">
    <div class="header">
        <div class="header-one">
            <img src="{{asset('dashboard_assets/Talbinah.png')}}" alt="Company Logo">
            <h1>Talbinah Medical</h1>
        </div>
        <div class="header-two">
            <a href="#">www.Talbinah.Com</a>
        </div>
    </div>
    <div class="content">
        <p>Hello,</p>
    ...
    <div class="footer">
        <p>Copyright &copy; 2023 <span class="footer-name">Talbinah.</span> All rights reserved</p>
        <p>Template Made by <span class="footer-link">i3mal.com</span></p>
        <div class="social-icons">
            <a href="https://www.facebook.com/TalbinahApp" target="_blank" class="social-icon"><i class="fab fa-facebook-f"></i></a>
            <a href="https://twitter.com/Talbinahco" target="_blank" class="social-icon"><i class="fab fa-twitter"></i></a>
            <a href="https://www.instagram.com/talbinahco/" target="_blank" class="social-icon"><i class="fab fa-instagram"></i></a>
