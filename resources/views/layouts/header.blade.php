                    ...
                    <div
                        ...
                        <div class="dc-rightarea mr-auto">
                            <ul class="dc-simplesocialicons dc-socialiconsborder">
                                <li class="dc-facebook"><a href="https://www.facebook.com/TalbinahApp"><i
                                            class="fab fa-facebook-f"></i></a></li>
                                <li class="dc-twitter"><a href="https://twitter.com/Talbinahco"><i
                                ...
                                <li class="dc-instagram"><a href="https://www.instagram.com/talbinahco/"><i
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 header-two">
                        <strong class="dc-logo"><a href="{{route('home')}}"><img
                                    src="{{url('/assets/images/logo/logo_talbinah.png')}}" style="width: 138px;"
