...
@section('meta')
    <title> @lang('custom.Talbinah Contact Us')</title>
	<meta name="title" content=" Talbinah App - Contact Us">
	<meta name="description" content="You have questions or inquiries about the Talbinah application and the mental health services that it provides
    We offer? Feel free to contact us now. Download the Talbinah app and join the mental health care community.">

    <!-- Open Graph / Facebook -->
	<meta property="og:type" content="website">
	<meta property="og:url" content="https://metatags.io">
	<meta property="og:title" content="Talbinah App - Contact Us">
	<meta property="og:description" content="You have questions or inquiries about the Talbinah application and the mental health services that it provides
    We offer? Feel free to contact us now. Download the Talbinah app and join the mental health care community.">
	...
	<meta property="twitter:title" content="Talbinah App - Contact Us">
	<meta property="twitter:description" content="You have questions or inquiries about the Talbinah application and the mental health services that it provides
    We offer? Feel free to contact us now. Download the Talbinah app and join the mental health care community.">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="dc-cntctfrmdetail">
                        ...
                        <ul class="dc-formcontactus">
                            ...
                            <li><a href="javascript:void(0)"><i class="lnr lnr-envelope"></i> info@talbinah.net </a></li>
