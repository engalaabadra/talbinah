...
@section('page_header')
    ...
    <li class="breadcrumb-item">
        <a href="" class="text-muted">@lang('admin/dashboard.doctors')</a>
    </li>
@endsection
@section('content')
            ...
            <div class="row">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label"> @lang('admin/dashboard.doctors')</h3>
                    </div>
                            ...
                            @foreach($users as $index => $user)
                                <tr id="row-{{$user->id}}">
                                    ...
                                    <td class="dt_action_btn_cont text-center">
                                        ...
                                        <a
                                            href="{{route('admin.doctors.show',$user->id)}}"
                                        ...
                                        <a class="btn btn-sm btn-clean btn-icon"
                                           ...
                                           data-url="{{route('admin.doctors.destroy',$user->id)}}"
