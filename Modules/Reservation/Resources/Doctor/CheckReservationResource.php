...
class CheckReservationResource extends JsonResource
{
    use GeneralTrait;
    ...
    public function toArray($request)
    {
        ...
        return [
            'remaining_time'=>$this->visitCall ? $this->remainingTimeReservation($this->visitCall->visit_time_doctor,$this->duration->duration) : $this->duration->duration * 60,
